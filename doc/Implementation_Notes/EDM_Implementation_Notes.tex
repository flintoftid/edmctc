% This is part of the Electromagnetic Diffusion Model Canonical Example 
% Suite Implementation Notes
%
% Copyright (C) 2017-2018 Ian D. Flintoft <ian.flintoft@googlemail.com>
%
% See the file fdl-1.3.tex for copying conditions.
%
...
\usepackage{float}
\usepackage{hyperref}
\hypersetup{colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=Electromagnetic Diffusion Model Canonical Example Suite Implementation Notes, pdfauthor=Ian Flintoft, pdfkeywords=power balance; diffusion; statistical energy balance}
...
\textbf{\Large Electromagnetic Diffusion Model Canonical Example Suite Implementation Notes}
\par}
\vspace{5mm}
\thispagestyle{plain}
{\centering\large 
