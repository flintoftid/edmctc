...
The above developement is sufficient to implement a numerical solution in FreeFEM++; for 
...
\end{align}
The elements are typically triangles in 2D or tetrahdera in 3D.
...
\end{align}
where the signe and magnitude of $\beta$ are chosen to give a stable scheme. This Schwarz approach
