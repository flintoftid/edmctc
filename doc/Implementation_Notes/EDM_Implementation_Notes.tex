...
$J_\rs$             &W\,m$^{-2}$     &\texttt{srcLineExitance}    &Contour source line exitance \\
...
that applied to explicit finite-difference approximations of
the diffusion equations does not have to be satisfied.
...
\vspace{-4mm}
\caption{\label{fg:tcgeom} Tetrahedral mesh of the coupled cavities test-case containing the lossy cylinder.}
\end{center}
\end{figure}
