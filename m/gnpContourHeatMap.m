function gnpContourHeatMap( x , y, v , xMin , xMax , xLabel , yMin , yMax , yLabel , vMin , vMax , vLabel , vCont , tag )
%gnpContourHeatMap - plot hybrid heat and contour map of 2D scalar field
% using gnuplot.
%
...
%
  ...
  fprintf( fp , 'plot "%s" us 1:2:3 w image, "< %s %s 1 5 1" w l lt -1 lw 1.5\n' ,  datFileName , contGeneratorScript , contFileName ); 
  fclose( fp );
